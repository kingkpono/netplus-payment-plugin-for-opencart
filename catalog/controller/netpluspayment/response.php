...
{
//update order status
$this->model_checkout_order->addOrderHistory($order_id, $this->config->get('netpluspayment_payment_success_status_id'),$status_from_netplus);
...
if(!isset($delivery_response->error) && !isset($delivery_response->fail))
{
 ...
 $this->db->query("UPDATE " . DB_PREFIX . "order_status SET name = '".$output."' WHERE order_status_id=".$this->config->get('netpluspayment_order_status_id'));

$this->model_checkout_order->addOrderHistory($order_id, $this->config->get('netpluspayment_shipment_status_id'),$output);
   ...
   $this->model_checkout_order->addOrderHistory($order_id, $this->config->get('netpluspayment_payment_failure_status_id'),$status_from_netplus);
